...
#
# Experimental images are not yet available for
ifdef USE_EXPERIMENTAL_EDX_PLATFORM_IMAGES
	...
	_STUDIO_IMAGE       = openedx/studio-dev:latest
	# @@TODO: remove before review
	_LMS_IMAGE          = kdmccormick96/lms-dev:latest
	_STUDIO_IMAGE       = kdmccormick96/studio-dev:latest
endif
ifdef USE_EXPERIMENTAL_CREDENTIALS_IMAGE
	_CREDENTIALS_IMAGE  = openedx/credentials:latest
endif
...
# to use the `USE_EXPERIMENTAL_*_PLATFORM_IMAGES` or `OPENEDX_RELEASE` settings.
#
